          ...
          <div className="flex items-center flex-1">
            <div className="flex items-center justify-between w-full md:w-auto">
              ...
              <div className="-mr-2 flex items-center md:hidden">
                <PopoverButton className="bg-green-600 rounded-md p-2 inline-flex items-center justify-center text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white">
        ...
        >
          <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
            <div className="px-5 pt-4 flex items-center justify-between">
              ...
              <div className="-mr-2">
                <PopoverButton className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500">
                ...
                {currentUser ? (
                  <>
                    ...
                    <div className="mt-4 flex justify-around">
                      <Link
                        to="/cart"
                        className="text-center py-2 text-base font-medium text-gray-500 hover:text-gray-900"
                      >
