...
import { TabPanels, TabPanel, DisclosureButton, DisclosurePanel,TabGroup, TabList, Label, Radio  } from '@headlessui/react'
...
export default function Product() {
  ...
  //fetching will done using this param product id

  return (
    <div className="bg-white">
      <div className="mx-auto py-16 px-4 sm:py-24 sm:px-0 lg:px-8">
